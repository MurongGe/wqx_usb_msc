...
#define W25Q128_SPI_TIMEOUT 0xffff
#define WQX_SPI_INTERFACE 	&hspi3
#define WQX_CS_PIN 					WQX_CS1_Pin
#define WQX_CS_PIN_Port 		WQX_CS1_GPIO_Port
...
#define WQX_USE_FATFS 0 /** >>! 使用文件系统 **/
#define WQX_TEST 0      /** 测试是否读写正常 **/
#define USE_4KRW_MODE 1

/** 定义W25QXX与文件系统相关的 **/
#if WQX_USE_FATFS
#define WQX_SECTOR_SIZE 512U                                              // W25QXX 操作扇区
#define WQX_OFFSET_SECTOR (uint32_t)(4 * 1024 * 1024 / WQX_SECTOR_SIZE)   // 向后偏移4M字节 = 4*1024*1024/512=4096*2
#define WQX_SECTOR_OF_BLOCK 8                                             // 每个BLOCK个sector
#define WQX_CAPCITY_SECTOR (uint32_t)(12 * 1024 * 1024 / WQX_SECTOR_SIZE) // 向后偏移4M空间
